...
export default function Leftbanner(props) {
    ...
    return (
        <div className="icon-wrapper">
            <div className="icon">Kahilipara Senior Citizen Association</div>
            <br />
